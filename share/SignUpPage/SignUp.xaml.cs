...
namespace share
{
	...
	public partial class SignUp : ContentPage
	{
		...
		Entry ETname,ETnickName,ETphoneNumber;
        PersonalPage.PersonalData.BindingData bindingData;
        private void InitializeDataBinding()
        {
            bindingData = new PersonalPage.PersonalData.BindingData(PersonalPage.PersonalData.main);
            bindingData.SetBinding(ETname, ETnickName, ETphoneNumber);
        }
        private void InitializeViews()
        {
            ...
            grid.Children.Add(ETphoneNumber, 2, 5);
            ...
            grid.Children.Add(ETnickName, 2, 6);
